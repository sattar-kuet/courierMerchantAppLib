...
class TransactionPaid extends StatelessWidget {
  const TransactionPaid({super.key, this.startDate, this.endDate});
    ...
    return ChangeNotifierProvider(
      create: (context) => TransactionProvider()
        ..transactionListAction(context,
            status: 'paid', endDate: endDate, startDate: startDate),
      child: Scaffold(
